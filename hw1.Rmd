...
To begin this problem, I will create an example tibble data frame with `tidyverse`'s `tibble` function. This example data frame will have four columns, one of each data type of numeric, logical, character, and factor. 
